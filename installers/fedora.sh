...
dnf check-update -v
sudo dnf install 2048-cli alien apostrophe audacity dconf-editor deja-dup ffmpeg-free gcc gcc-c++ ghex gimp gnome-extensions-app gnome-tweaks golang htop java-17-openjdk-* mpv ncdu neofetch nmap nodejs nvtop obs-studio thefuck seahorse steam xkill yt-dlp -y -v

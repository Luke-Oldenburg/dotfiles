...
dnf check-update -v
sudo dnf install 2048-cli alien audacity blender chromium dconf-editor deja-dup epiphany fastfetch ffmpeg-free gcc gcc-c++ gh.x86_64 ghex gimp gnome-extensions-app gnome-firmware gnome-tweaks godot golang htop inkscape java-21-openjdk* kicad mpv ncdu nmap nodejs obs-studio redis rust seahorse steam tailscale wget2-wget xkill yt-dlp -yv

...
dnf check-update
sudo dnf install 2048-cli alien audacity blender brainfuck cowsay dconf-editor deja-dup fastfetch ffmpeg-free gcc gcc-c++ gh.x86_64 ghex gimp gnome-extensions-app gnome-firmware gnome-tweaks godot golang htop inkscape java-21-openjdk* kicad mpv ncdu nmap nodejs obs-studio redis rust seahorse solaar steam tailscale thefuck wget2-wget xkill yt-dlp -y

...
dnf check-update -v
sudo dnf install 2048-cli alien apostrophe audacity blender chirp dconf-editor deja-dup fastfetch ffmpeg-free gcc gcc-c++ ghex gimp gnome-extensions-app gnome-tweaks godot golang htop java-17-openjdk-* kicad mpv ncdu nmap nodejs nvtop obs-studio rust seahorse steam wget2-wget xkill yt-dlp -y -v
